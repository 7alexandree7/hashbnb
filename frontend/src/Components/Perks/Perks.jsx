...
const Perks = () => {
    ...
    const handleClick = (target) => {
        const newPerks = target.checked ? [...perks, target.value] : [...perks].filter((p) => p !== target.value);
        setPerks(newPerks);
  ...
  return (
      <div className='grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4'>
          <label htmlFor="wifi" className='flex items-center gap-2 px-4 py-2'>
              <input
                  type="checkbox"
                  id="wifi"
                  value="Wi-Fi"
          ...
          <label htmlFor="parking" className='flex items-center gap-2 px-4 py-2'>
              <input
                  type="checkbox"
                  id="parking"
                  value="parking"
          ...
          <label htmlFor="tv" className='flex items-center gap-2 px-4 py-2'>
              <input
                  type="checkbox"
                  id="tv"
                  value="tv"
          ...
          <label htmlFor="radio" className='flex items-center gap-2 px-4 py-2'>
              <input
                  type="checkbox"
                  id="radio"
                  value="radio"
          ...
          <label htmlFor="pets" className='flex items-center gap-2 px-4 py-2'>
              <input
                  type="checkbox"
                  id="pets"
                  value="pets"
          ...
          <label htmlFor="entrance" className='flex items-center gap-2 px-4 py-2'>
              <input
                  type="checkbox"
                  id="entrance"
                  value="entrance"
